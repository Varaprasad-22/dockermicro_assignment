...
@Component
public class JwtAuthentcationFilter implements GlobalFilter, Ordered {
    ...
    private boolean isPublicEndpoint(String path) {
        return path.startsWith("/api/auth/") || 
               ...
               // Match /api/flights/{flightId} by checking if it ends with a variable
               path.matches("/api/flights/[^/]+") || 
               // If search has sub-paths
